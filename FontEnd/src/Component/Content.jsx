    ...
    <div>
                ...
                <div className="blog-inner-right-fourt">
                  <a href="doctor-profile.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/doctors/veterinary-doctor-01.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                  ...
                  <ul className="articles-list nav blog-articles-list">
                    <li>
                      <i className="fa fa-location-dot" /> <strong>0.9</strong>{" "}
                      min - New York, USA
                    </li>
                  </ul>
              ...
              <div className="card-body blog-inner-fourt-main">
                <div className="blog-inner-right-fourt">
                  <a href="doctor-profile.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/doctors/veterinary-doctor-02.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                      <div className="blog-inner-top-content content-pricing">
              ...
              <div className="card-body blog-inner-fourt-main">
                <div className="blog-inner-right-fourt">
                  <a href="doctor-profile.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/doctors/veterinary-doctor-03.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                      <div className="blog-inner-top-content content-pricing">
                  ...
                  <ul className="articles-list nav blog-articles-list">
                    <li>
                      <i className="fa fa-location-dot" /> <strong>0.8</strong>{" "}
                      min - Sandiago, USA
                    </li>
                  </ul>
                  <div className="blog-list-ratings">
              ...
              <div className="card-body blog-inner-fourt-main">
                <div className="blog-inner-right-fourt">
                  <a href="doctor-profile.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/doctors/veterinary-doctor-04.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                      <div className="blog-inner-top-content content-pricing">
      ...
      <div className="blog-section-fourteen">
        <div className="container">
          ...
          <div
            className="owl-carousel blog-slider-fourteen owl-theme aos"
            data-aos="fade-up"
          >
            <div className="card blog-inner-fourt-all">
              <div className="card-body blog-inner-fourt-main">
                <div className="blog-inner-right-fourt">
                  <a href="blog-details.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/blog/veterinary-blog-01.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                      <div className="blog-inner-top-content">
                  ...
                  <p>
                    ...
                    do eiusmod tempor incididunt ut labore et dolore ad minim
                    veniam, quis magna aliqua.{" "}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card-body blog-inner-fourt-main">
                <div className="blog-inner-right-fourt">
                  <a href="blog-details.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/blog/veterinary-blog-02.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                      <div className="blog-inner-top-content">
              ...
              <div className="card-body blog-inner-fourt-main">
                <div className="blog-inner-right-fourt">
                  <a href="blog-details.html">
                    <div className="blog-inner-right-img">
                      <img
                        src="../src/assets/img/blog/veterinary-blog-03.jpg"
                        alt="image"
                        className="img-fluid "
                      />
                      <div className="blog-inner-top-content">
