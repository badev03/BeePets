...
const Header = () => {
  return (
    <header className="header header-fixed header-fourteen header-twelve" >
        ...
        <img src="../src/assets/img/logo.png" className="img-fluid" alt="Logo"/>
        </a>
        ...
        <li className="has-submenu">
        <a href="#">TIN TỨC <i className="fas fa-chevron-down"></i></a>
        </li>
        </ul>
        </div>
        ...
        <li className="login-link"><a href="login-email.html">Đăng nhập / Đăng kí</a></li>
        <li className="login-in-fourteen">
        <a href="login-email.html" className="btn reg-btn"><i className="feather-user me-2"></i>Đăng nhập</a>
        </li>
        <li className="login-in-fourteen">
        <a href="signup.html" className="btn btn-primary reg-btn reg-btn-fourteen"><i className="feather-user me-2"></i>Đăng kí</a>
        </li>
        </ul>
        </nav>
        </div>
