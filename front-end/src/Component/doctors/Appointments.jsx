...
const Appointments = () => {
              ...
              <Dropdown
                overlay={
                  <Menu>
                    ...
                    <Menu.Item>
                      <div
                        onClick={() => showModalCancel(appointment.id)}
                        style={{ width: "100%" }}
  ...
  return (
    <div>
             <BreadcrumbBar title="LỊCH HẸN" lable="Lịch hẹn" />
              ...
              <div className="search-container">
                <form className="filter-form" onSubmit={handleFilterSubmit}>
                  ...
                  <div className="filter-section">
                    ...
                    <div className="filter-item">
                      <label htmlFor="searchPhone" className="label-text">
                          ...
                          <Form.Item
                            ...
                            rules={[
                              ...
                              },
                              {
                                min: 6,
                                message:
                                  "Lí do đổi lịch phải có ít nhất 6 ký tự!",
                              },
                            ]}
                          >
                            <Input.TextArea
